...
from Ibrahim.networks.DeepLab_utils import _SimpleSegmentationModel
...
class DeepLabHeadV3Plus(nn.Module):
    def __init__(self, in_channels, low_level_channels, num_class, aspp_dilate=[12, 24, 36]):
        ...
        self.classifier = nn.Sequential(
            ...
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            nn.Conv2d(256, num_class, 1) #num_class=1 for binary , multi
        )
